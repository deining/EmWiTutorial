...
C.Canvas={Cr:B.pn,HA:null,Ds:0,EB:false,Co:function(){if(this.EB)this.DetachBitmap(
);},BN:function(aArg){this.DW=true;},Gv:function(value){if((value[0]<=0)||(value[
...
1]>0))(A=this.HA)?A[1].call(A[0],this):null;this.Cr=BV;}},DetachBitmap:function(
...
this.BZ=(this.FrameDelay>0)&&(this.NoOfFrames>1);return this;},Hi:function(aClip
,GI,aString,aOffset,aCount,aDstRect,aSrcPos,aMinWidth,GK,aColorTL,aColorTR,aColorBR
,aColorBL,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap)return;if(aOffset<
0)aOffset=0;if((!GI||!GI.font)||((aOffset>0)&&(aOffset>=aString.length)))return;
var orient=0;if(GK===1)orient=90;else if(GK===2)orient=180;else if(GK===3)orient=
270;var dstFrameNo=this.Ds;var dstBitmap=this.bitmap;var srcFont=GI.font;{B.mf(dstBitmap
,srcFont,aString,aOffset,aCount,dstFrameNo,aClip,aDstRect,aSrcPos,aMinWidth,orient
,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},Im:function(aClip,aBitmap,aFrameNr
...
,aColorTR,aColorBR,aColorBL,aBlend);}},GC:function(aClip,aBitmap,aFrameNr,aDstX1
...
,aDstY1,aDstW1,aDstX2,aDstY2,aDstW2,aDstX3,aDstY3,aDstW3,aDstX4,aDstY4,aDstW4,aSrcRect
,aColor1,aColor2,aColor3,aColor4,aBlend,aFilter);}},Ja:function(aClip,aBitmap,aFrameNr
...
,aColorBL,aBlend,aFilter);}},He:function(aClip,aBitmap,aFrameNr,aDstRect,aSrcPos
...
,aColorTR,aColorBR,aColorBL,aBlend);}},Hh:function(aClip,aDstRect,aEdgeWidth,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap
)return;var dstBitmap=this.bitmap;var dstFrameNo=this.Ds;{B.rF(dstBitmap,dstFrameNo
,aClip,aDstRect,aEdgeWidth,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},FZ:function(
...
this);},_Mark:function(D){var A;B.tf.X._Mark.call(this,D);if((A=this.HA)&&((A=A[
0])._cycle!=D))A._Mark(A._cycle=D);},_className:"Graphics::Canvas"};C.Hj={Left:0x1
,Ki:0x2,Right:0x4,JM:0x8,JW:0x10};
