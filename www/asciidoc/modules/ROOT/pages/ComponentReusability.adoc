...
.Source code
****
TIP: If you didn't author or didn't keep the _First component_ project explained in the previous xref::FirstComponent.adoc[chapter], you may download the link:{attachmentsdir}/code/code/FirstComponentTutorial.zip[sources] of this project and use this a starting base to follow the instructions given below.
****
'''
