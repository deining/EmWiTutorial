...
var DB="No view to remove";var GD="No view to add";var GE="View already in a group";
var GF="Recursive invalidate during active update cycle.";var GG="The KeyPressHandler is embedded within an object not being derived "+
"from Core::Group.";
C.Bu={Y:null,R:null,G:null,E:0x103,Ao:null,Cf:0x14,EE:function(T,Fm){},HE:function(
...
}},DV:function(){var V=this.G;while(!!V){var H_=(C.Root.isPrototypeOf(V)?V:null);
if(!!H_)return H_;V=V.G;}return null;},B0:function(Ar,aClip,aOffset,Aq,aBlend){}
,A2:function(Aa){return null;},CR:function(Ad,J,BH,D4,DF){return null;},ET:function(
T,BX){return Ai;},Gs:function(aOffset,Fl){},GetExtent:function(){return AF;},A7:
function(CX,DE){var A;if(((this.E&0x200)===0x200))CX=CX&~0x400;var G1=(this.E&~DE
)|CX;var Dj=G1^this.E;this.E=G1;if(!!this.G&&!!(Dj&0x14)){var HY=((this.E&0x14)===
0x14);if(HY&&!this.G.B1)this.G.Db(this);if(!HY&&(this.G.B1===this))this.G.Db(this.
G.Hk(this,0x14));}if(!!this.G&&!!(Dj&0x403))this.G.Ag(this.GetExtent());if((!!this.
Ao&&((G1&0x400)===0x400))&&((Dj&0x1)===0x1)){this.E=this.E|0x800;this.G.E=this.G.
...
EE:function(T,Fm){var U=B._NewObject(C.E4,0);this.Ao=null;U.By=this.GetExtent();
U.Z=T;U.DN=Fm;U.EJ=this.Bp;U.EK=this.A3;U.EL=this.Bq;U.EM=this.A4;this.Ao=U;},ET:
...
1]-C0)*An)/CM)|0)]);this.Ao=U;}return[Ap+1,An+1];},Gs:function(aOffset,Fl){if(Fl
...
,A.A1],this);}},Gj:function(Cw){var Au=B.sr(4,B.pm,null);var I=0;var Ax=3;var GW=
false;var GX=false;Au.Set(0,this.Bp);Au.Set(1,this.A3);Au.Set(2,this.Bq);Au.Set(
3,this.A4);while(I<4){var Id=Au.Get(I)[0];var FO=Au.Get(I)[1];var JE=Au.Get(Ax)[
0];var Hd=Au.Get(Ax)[1];if(((FO>Cw[1])!==(Hd>Cw[1]))||((FO<Cw[1])!==(Hd<Cw[1]))){
var Ie=((((JE-Id)*(Cw[1]-FO))/(Hd-FO))|0)+Id;if(Cw[0]>Ie)GW=!GW;if(Cw[0]<Ie)GX=!
GX;}Ax=I;I=I+1;}return GW||GX;},Iu:function(){return((((this.Bp[0]===this.A4[0])&&(
...
T,Fm){var U=B._NewObject(C.Ek,0);U.By=this.O;U.Z=T;U.DN=Fm;this.Ao=U;},ET:function(
...
P-M,Q-N];},Gs:function(aOffset,Fl){if(Fl)this.O=B.sq(this.O,aOffset);else this.Am(
...
C.Ah={Bl:null,A6:null,FB:null,BY:null,Dk:null,DJ:null,B1:null,Dx:255,B0:function(
Ar,aClip,aOffset,Aq,aBlend){var A;Aq=((Aq+1)*this.Dx)>>8;aBlend=aBlend&&((this.E&
0x2)===0x2);if(!this.BY)this.Jr(Ar,aClip,B.so(aOffset,this.O.slice(0,2)),Aq,aBlend
);else{var Bv=255|(255<<8)|(255<<16)|((Aq&0xFF)<<24);this.BY.Update();Ar.He(aClip
,this.BY,0,B.sq(this.O,aOffset),Ai,Bv,Bv,Bv,Bv,aBlend);}},CR:function(Ad,J,BH,D4
,DF){var A;var H=this.A6;var DL=null;var S=AF;var Bm=null;var G0=!!this.DJ&&(!!this.
DJ.GR||!!this.DJ.Bl);if(((A=B.hV(Ad,this.O))[0]>=A[2])||(A[1]>=A[3]))return null;
...
this.Dk.BJ===H)&&!G0))){var By=H.GetExtent();var Fs=D4;var DH=null;if(Fs===H)Fs=
null;if(((H.E&0x400)===0x400)){if(!(((A=B.hV(By,S))[0]>=A[2])||(A[1]>=A[3])))DH=
H.CR(S,J,BH,Fs,DF);}else{if(!(((A=B.hV(By,Ad))[0]>=A[2])||(A[1]>=A[3]))||(D4===H
))DH=H.CR(Ad,J,BH,Fs,DF);}H=H.R;if(!!DH){if(!DL||((DH.Ec<DL.Ec)&&(DH.Ec>=0)))DL=
DH;if(!DH.Ec)H=null;}}else H=H.R;}return DL;},A7:function(CX,DE){var A;var Ju=this.
E;C.AN.A7.call(this,CX,DE);var Dj=this.E^Ju;if(!!this.B1&&((Dj&0x40)===0x40)){if(((
...
Do=[(A=this.O)[2]-A[0],A[3]-A[1]];var FF=[value[2]-value[0],value[3]-value[1]];var
DQ=!B.sa(Do,FF);if(DQ&&!!this.BY){this.BY.Gv(FF);B.pl(this,0);B.pl(this.BY,0);}C.
...
)H.EE(Z,null);H=H.Y;}}if(DQ){this.E=this.E|0x5000;B.kD([this,this.A1],this);}},G9:
function(Aa){var H0=(C.KeyEvent.isPrototypeOf(Aa)?Aa:null);var Ck=this.FB;if(!H0
)return null;while(!!Ck&&(!Ck.BL||!Ck.A2(H0)))Ck=Ck.Y;return Ck;},Jr:function(Ar
,aClip,aOffset,Aq,aBlend){var A;var H=this.Bl;var HW=AF;var H8=true;while(!!H){if(((
H.E&0x200)===0x200)){var H7=(C.Ep.isPrototypeOf(H)?H:null);HW=B.hV(aClip,B.sq(H7.
O,aOffset));H8=((H7.E&0x1)===0x1);}if(((H.E&0x1)===0x1)){if(((H.E&0x400)===0x400
)){if(H8){var S=B.hV(B.sq(H.GetExtent(),aOffset),HW);if(!((S[0]>=S[2])||(S[1]>=S[
...
JA:function(){var A;var GU=((this.E&0x1000)===0x1000);var C1=[0,0,(A=this.O)[2]-
A[0],A[3]-A[1]];var CO=false;var DK=AF;var Fu=Ai;var ED=0;var Ft=0;var H=this.A6;
...
E=H.E|0x1000;}H=H.R;}CO=false;H=this.Bl;if(GU){this.E=this.E&~0x1000;GU=!((C1[0]>=
C1[2])||(C1[1]>=C1[3]));}this.E=this.E|0x2000;while(!!H){if(((H.E&0x400)===0x400
)){if(!!H.Ao&&(H.Ao.DN!==Bm))H.Ao=null;if((!H.Ao&&CO)&&((H.Cf!==EC)||!!Ft))H.EE(
DK,Bm);}if(!!H.Ao){if(GU&&!((H.E&0x400)===0x400))H.ET(C1,0);if(CO&&((H.E&0x400)===
0x400)){var AM=H.ET(B.sq(DK,Fu),Ft);if(((H.E&0x1)===0x1)){var BS=Ai;switch(Ft){case
3:BS=[AM[0]+ED,BS[1]];break;case 4:BS=[-AM[0]-ED,BS[1]];break;case 1:BS=[BS[0],AM[
1]+ED];break;case 2:BS=[BS[0],-AM[1]-ED];break;default:;}Fu=B.so(Fu,BS);}}}if(((
H.E&0x200)===0x200)){CO=((H.E&0x1000)===0x1000);Bm=(C.Ep.isPrototypeOf(H)?H:null
);if(CO){H.E=H.E&~0x1000;DK=B.sq(Bm.O,Bm.CF);Fu=Ai;Ft=Bm.EZ;ED=Bm.Space;CO=!((DK[
0]>=DK[2])||(DK[1]>=DK[3]));}if(CO){this.Ag(Bm.O);}}H=H.Y;}this.E=this.E&~0x2000;
this.HM([C1[2]-C1[0],C1[3]-C1[1]]);},A1:function(Az){var A;var JD=((this.E&0x1000
)===0x1000);if(((this.E&0x4000)===0x4000)){this.E=this.E&~0x4000;this.JA();}if(((
this.E&0x8000)===0x8000)||JD){this.E=this.E&~0x8000;this.Ev(this.E);}},Db:function(
...
){if(((this.E&0x40)===0x40))value.A7(0x60,0x0);else value.A7(0x20,0x0);}},Hw:function(
...
null);var Aj=null;var G0=!!this.DJ&&(!!this.DJ.GR||!!this.DJ.Bl);if(!!H&&((((H.E&
0x10000)===0x10000)||((H.E&0x40000)===0x40000))||((H.E&0x20000)===0x20000))){H=null;
V=null;}if(!!this.Dk&&!G0)Aj=this.Dk.BJ.DispatchEvent(Aa);if(!Aj&&!!V)Aj=V.DispatchEvent(
Aa);else if(!Aj&&!!H)Aj=H.A2(Aa);if(!Aj)Aj=this.A2(Aa);if(!Aj)Aj=this.G9(Aa);return Aj;
},BroadcastEventAtPosition:function(Aa,HR,aFilter){var A;var H=this.A6;var Aj=null;
while(!!H&&!Aj){if((!aFilter||((A=aFilter)&&((H.E&A)===A)))&&B.se(H.GetExtent(),
HR)){var V=(C.Ah.isPrototypeOf(H)?H:null);if(!!V)Aj=V.BroadcastEventAtPosition(Aa
,B.sn(HR,V.O.slice(0,2)),aFilter);else Aj=H.A2(Aa);}H=H.R;}if(!Aj)Aj=this.A2(Aa);
...
)Aj=this.A2(Aa);if(!Aj)Aj=this.G9(Aa);return Aj;},HM:function(aSize){},Ev:function(
...
)){B.pl(V,0);B.pl(D6,0);}var GT=false;if(GT)D6.Cr=[0,0,(A=V.O)[2]-A[0],A[3]-A[1]
];else D6.Cr=B.pA(D6.Cr,Ad);}if(!((V.E&0x1)===0x1))return;Ad=B.hV(B.sq(Ad,V.O.slice(
0,2)),V.O);V=V.G;}},BN:function(aArg){this.Cs();},Hk:function(F,aFilter){var A;if(
...
Dn=Dn.Y;if(!!Dp)Dp=Dp.R;}return null;},GA:function(F,Cj){var A;if(!F)throw new Error(
...
Y=null;this.A6.Y=F;this.A6=F;if(((F.E&0x1)===0x1))this.Ag(F.GetExtent());},Gz:function(
...
if(!F.R)this.Bl=F;if(((F.E&0x1)===0x1))this.Ag(F.GetExtent());},Gy:function(F){var
...
B.kD([this,this.A1],this);}F.Ao=null;if(this.B1===F)this.Db(this.Hk(F,0x14));if(
...
Bi:function(F,Bj){var A;if(!F)throw new Error(GD);if(!!F.G)throw new Error(GE);F.
G=this;F.R=this.A6;if(!!this.A6)this.A6.Y=F;this.A6=F;if(!this.Bl)this.Bl=F;if(!
!Bj)this.Gz(F,Bj);if(((F.E&0x1)===0x1))this.Ag(F.GetExtent());if(((!this.B1&&((F.
...
A._cycle=D);if((A=this.FB)&&(A._cycle!=D))A._Mark(A._cycle=D);if((A=this.BY)&&(A.
...
A._Mark(A._cycle=D);},_className:"Core::Group"};C.Root={BB:null,ER:0,GN:0,C3:null
,Aw:0,CK:null,AV:B.sr(10,0,null),Fr:B.sr(10,B.pn,null),B8:B.sr(10,0,null),CJ:B.sr(
10,B.pm,null),D9:B.sr(10,0,null),Cy:null,CY:B.sr(10,B.pm,null),As:B.sr(10,null,null
),B7:B.sr(10,B.pm,null),BI:B.sr(10,B.pm,null),Cz:B.sr(10,B.pm,null),Ae:0,Fw:0,Fv:
0,FD:B.sr(3,B.pn,null),H4:0,D7:null,Bn:B.sr(4,0,null),AT:B.sr(4,B.pn,null),AL:0,
AU:null,C8:8,Il:250,Dl:0,C2:0,GV:true,FC:false,DV:function(){return this;},B0:function(
Ar,aClip,aOffset,Aq,aBlend){var fullScreenUpdate=false;fullScreenUpdate=B.i6;if(
!fullScreenUpdate)Ar.FZ(aClip,B.sq(B.sq(aClip,aOffset),this.O.slice(0,2)),0x00000000
...
function(Aa){if((this.GN>0)&&!!(C.KeyEvent.isPrototypeOf(Aa)?Aa:null))return null;
...
BJ.DispatchEvent(Aa);if(!Aj)Aj=this.A2(Aa);if(!Aj)Aj=this.G9(Aa);this.Aw=0;return Aj;
...
Error(GF);if(!!this.BY&&!this.G){if(((A=this.BY.Cr)[0]>=A[2])||(A[1]>=A[3])){B.pl(
this,0);B.pl(this.BY,0);}var GT=false;if(GT)this.BY.Cr=[0,0,(A=this.O)[2]-A[0],A[
...
var HT=2147483647;this.AT.Set(this.AL,Ad);this.Bn.Set(this.AL,B.rY(Ad));for(Ax=0;
Ax<=this.AL;Ax=Ax+1)for(BA=Ax+1;BA<=this.AL;BA=BA+1){var FN=B.rY(B.pA(this.AT.Get(
Ax),this.AT.Get(BA)));var H9=((FN<<8)/(this.Bn.Get(Ax)+this.Bn.Get(BA)))|0;if(H9<
HT){HT=H9;EF=Ax;EG=BA;}}this.AT.Set(EF,B.pA(this.AT.Get(EF),this.AT.Get(EG)));this.
Bn.Set(EF,B.rY(this.AT.Get(EF)));if(EG!==this.AL){this.AT.Set(EG,this.AT.Get(this.
AL));this.Bn.Set(EG,this.Bn.Get(this.AL));}},GA:function(F,Cj){if((!Cj&&!!this.AU
)&&(this.AU.G===this))Cj=this.AU;C.Ah.GA.call(this,F,Cj);},Es:function(F){if(!!this.
AU&&(this.AU.G===this))this.GA(F,this.AU);else C.Ah.Es.call(this,F);},Gz:function(
F,Bj){if(!F)throw new Error(CG);if(((Bj>0)&&!!this.AU)&&(this.AU.G===this)){var H=
F;var FG=Bj;while((H.Y!==this.AU)&&(FG>0)){H=H.Y;FG=FG-1;}Bj=Bj-FG;}C.Ah.Gz.call(
this,F,Bj);},Bi:function(F,Bj){if(((Bj>=0)&&!!this.AU)&&(this.AU.G===this))Bj=-1;
C.Ah.Bi.call(this,F,Bj);},Jp:function(){var Bf=B._NewObject(C.EX,0);Bf.Ei=!!this.
...
B._NewObject(C.FQ,0);Bf.Ei=!!this.Aw;if(!!this.Aw)Bf.AG=this.Aw;return Bf;},Jq:function(
...
){var ticksCount=0;var HZ=0;ticksCount=((new Date).getTime()-B.pk)|0;if(!!this.Fw&&(
ticksCount>this.Fw))HZ=((this.Fv*1000)/((ticksCount-this.Fw)|0))|0;this.Fv=0;this.
Fw=ticksCount;return HZ;},Update:function(){var A;if(!this.D7){this.D7=B._NewObject(
B.Graphics.Canvas,0);this.D7.Gv([(A=this.O)[2]-A[0],A[3]-A[1]]);}this.D7.Update(
...
function(){if(this.AL>0){this.Fv=this.Fv+1;this.AL=0;}},UpdateCanvas:function(Ar
,aOffset){var A;var CP=AF;var Jn=[].concat(aOffset,B.so(Ar.FrameSize,aOffset));var
...
CP=B.pA(CP,B.hV(Jn,this.AT.Get(I)));}else Ax=Ax+1;}this.ER=this.ER-1;if(!((CP[0]>=
CP[2])||(CP[1]>=CP[3])))return B.sp(CP,aOffset);else return CP;},GetUpdateRegion:
function(Fn){var I;var Ax=this.AL;if(Fn<0)return AF;for(I=0;(I<Ax)&&(I<4);I=I+1){
if(!this.Bn.Get(I)){Ax=Ax+1;Fn=Fn+1;}else if(I===Fn)return this.AT.Get(I);}return AF;
},BeginUpdate:function(){var Jy=true;var fullScreenUpdate=false;var I;if((!Jy&&!
fullScreenUpdate)&&(this.AL>0)){var Ic=B.sr(3,B.pn,null);var Hc=this.AL;for(I=0;
I<Hc;I=I+1)Ic.Set(I,this.AT.Get(I));for(I=0;I<this.H4;I=I+1)this.Ag(this.FD.Get(
I));for(I=0;I<Hc;I=I+1)this.FD.Set(I,Ic.Get(I));this.H4=Hc;}var Ax;var BA;for(Ax=
0;Ax<(this.AL-1);Ax=Ax+1)if(this.Bn.Get(Ax)>0)for(BA=Ax+1;BA<this.AL;BA=BA+1)if(
this.Bn.Get(BA)>0){var FN=B.rY(B.pA(this.AT.Get(Ax),this.AT.Get(BA)));if(((FN-this.
Bn.Get(Ax))-this.Bn.Get(BA))<0){this.AT.Set(Ax,B.pA(this.AT.Get(Ax),this.AT.Get(
BA)));this.Bn.Set(Ax,FN);this.Bn.Set(BA,0);}}for(I=this.AL-1;I>=0;I=I-1)if(!this.
...
));if(this.GV)this.E=this.E|0x60;else this.E=this.E|0x20;this.Ag(this.O);return this;
},SetRootFocus:function(GJ){if(GJ===this.GV)return false;this.GV=GJ;if(!GJ){if(!
...
!this.AU)this.AU.A7(0x40,0x0);}return true;},SetUserInputTimestamp:function(Jm){
this.Aw=Jm;},DriveKeyboardHitting:function(AH,DD,BW){var A;var G_=!!this.BB;if(!
...
).Initialize2(DD,true);if(!!Ck)Ck.A2(Bf);else if(!!H)H.A2(Bf);}if(this.FC&&((!BW||(
this.Dl!==AH))||(this.C2!==DD))){this.Dl=0;this.C2=0x00;this.FC=false;}if((!this.
BB&&BW)&&(this.GN>0)){this.Dl=AH;this.C2=DD;this.FC=true;}if((!this.BB&&BW)&&!this.
FC){if(!!AH)this.BB=this.DispatchEvent(B._NewObject(C.KeyEvent,0).Initialize(AH,
...
BB)?A:null))this.BB=null;this.Dl=AH;this.C2=DD;G_=G_||!!this.BB;}this.Aw=0;return G_;
...
this.Ae=J;this.As.Get(J).A2(this.Jp().Initialize(J,AS,this.CJ.Get(J),BR,this.B8.
...
1]);if(!ticksCount){ticksCount=((new Date).getTime()-B.pk)|0;}var JB=this.Aw;this.
DriveMultiTouchMovement(J,AQ);AQ=this.BI.Get(J);this.Aw=JB;if(BW)this.Cz.Set(J,AQ
);if((BW&&!this.As.Get(J))&&!this.GN){var Bz=null;var AS=AQ;if(B.se(this.Fr.Get(
J),AQ)&&((ticksCount-this.D9.Get(J))<=(((A=this.Il)<0)?A+0x100000000:A)))this.AV.
Set(J,this.AV.Get(J)+1);else this.AV.Set(J,0);this.Fr.Set(J,B.sq(DI,AQ));this.D9.
Set(J,ticksCount);if((!!this.AU&&!!this.AU.G)&&((this.AU.E&0x18)===0x18)){var S=
B.sq(DI,this.AU.G.Hw(AQ));Bz=this.AU.CR(S,J,this.AV.Get(J)+1,null,0x0);}if(!Bz){
if(!!this.Cy&&!!this.Cy.G){if(((this.Cy.E&0x8)===0x8)&&((this.Cy.E&0x10)===0x10)
){var S=B.sq(DI,this.Cy.G.Hw(AQ));Bz=this.Cy.CR(S,J,this.AV.Get(J)+1,null,0x0);}
...
CI,HP,DF){var DI=[].concat([-this.C8,-this.C8],[this.C8+1,this.C8+1]);if(CI===this
)CI=null;if(!this.As.Get(this.Ae))return;var Bz;Bz=this.CR(B.sq(DI,this.BI.Get(this.
Ae)),this.Ae,1,CI,DF);if(!!Bz&&(this.As.Get(this.Ae)!==Bz.Bu))this.Hf(Bz.Bu,Bz.CV
);if(!Bz&&(this.As.Get(this.Ae)!==HP))this.Hf(HP,Ai);},Hf:function(CI,B4){if(!this.
...
Root.AV;(this.Fr=[]).__proto__=C.Root.Fr;(this.B8=[]).__proto__=C.Root.B8;(this.
...
BI=[]).__proto__=C.Root.BI;(this.Cz=[]).__proto__=C.Root.Cz;(this.FD=[]).__proto__=
C.Root.FD;(this.Bn=[]).__proto__=C.Root.Bn;(this.AT=[]).__proto__=C.Root.AT;this.
__proto__=C.Root;this.E=0x7F;this.CK.E9(50);this.CK.Eo=[this,this.Jq];},_Done:function(
...
},Initialize:function(AH,BW){this.AI=AH;this.Down=BW;this.Ak=0x00;var GP=AH-10;var
GO=AH-105;if((GP>=0)&&(GP<=9))this.Ak=(48+GP)&0xFFFF;if((GO>=0)&&(GO<=25))this.Ak=(
65+GO)&0xFFFF;if(AH===131)this.Ak=0x20;if(this.Ak===0x00)switch(AH){case 132:this.
...
return this;},Iz:function(HO){switch(HO){case 141:return((this.Ak>=0x41)&&(this.
...
AI===5);case 148:return(this.Ak!==0x00)||!!this.AI;default:;}return HO===this.AI;
},_Init:function(aArg){C.Event._Init.call(this,aArg);this.__proto__=C.KeyEvent;}
,_className:"Core::KeyEvent"};C.FQ={GB:null,Ce:B.pm,B3:0,BM:0,Down:false,Cm:false
,InitializeUp:function(J,BH,DC,GL,Ci){this.Down=false;this.BM=J;this.B3=BH;this.
Ce=Ci;this.GB=GL;this.Cm=DC;return this;},InitializeDown:function(J,BH,DC,GL,Ci){
this.Down=true;this.BM=J;this.B3=BH;this.Ce=Ci;this.GB=GL;this.Cm=DC;return this;
},_Init:function(aArg){C.Event._Init.call(this,aArg);this.__proto__=C.FQ;},_Mark:
function(D){var A;C.Event._Mark.call(this,D);if((A=this.GB)&&(A._cycle!=D))A._Mark(
...
0,Initialize:function(J,De,Ey,aOffset,Ez,Jl,B4,Ci,Ex){this.BM=J;this.Cb=B.so(De,
B4);this.CD=B.so(Ey,B4);this.CV=aOffset;this.Bt=Ez;this.B3=Jl;this.Ce=Ci;this.CU=
...
A=this.O)[2]-A[0],A[3]-A[1]];var FF=[value[2]-value[0],value[3]-value[1]];var DQ=
!B.sa(Do,FF);var BR=B.sn(value.slice(0,2),this.O.slice(0,2));if(!B.sa(BR,Ai)&&!DQ
){var H=this.Y;while(!!H&&!((H.E&0x200)===0x200)){if(((H.E&0x400)===0x400)){var tmp=((
H.E&0x100)===0x100);H.Gs(BR,tmp);}H=H.Y;}}if((DQ&&(Do[0]>0))&&(Do[1]>0)){var Z=B.
...
C.Ep;this.E=0x203;},_className:"Core::Outline"};C.Fj={GM:0,BM:0,AG:0,B3:0,Bt:0,CV:
B.pm,CD:B.pm,Cb:B.pm,Hz:null,Da:null,C$:null,Em:null,Cg:null,B2:null,I_:1000,Eu:
8,Dd:0x0,Hv:-1,Hx:1,IB:1,In:false,Down:false,CE:false,Cm:false,HS:false,B0:function(
Ar,aClip,aOffset,Aq,aBlend){},A2:function(Aa){var A;var Bg=(C.EV.isPrototypeOf(Aa
)?Aa:null);var AZ=(C.EX.isPrototypeOf(Aa)?Aa:null);var Fx=this.CE;if(!Bg&&!AZ)return null;
if(!!Bg){this.HS=Bg.Down;this.Down=Bg.Down;this.CE=this.Gj(Bg.Cb);this.CD=Bg.CD;
this.Cb=Bg.Cb;this.CV=Ai;this.Bt=Bg.Bt;this.B3=Bg.B3;this.Cm=Bg.Cm;this.BM=Bg.BM;
this.GM=Bg.BM;this.AG=Bg.AG;if(Bg.Down&&!Bg.Bt)Fx=false;}if(!!AZ){this.Down=true;
this.CE=this.Gj(AZ.Cb);this.CD=AZ.CD;this.Cb=AZ.Cb;this.CV=AZ.CV;this.Bt=AZ.Bt;this.
B3=AZ.B3;this.BM=AZ.BM;this.GM=AZ.BM;this.Cm=false;this.AG=AZ.AG;(A=this.Hz)?A[1
...
null;if((this.Down&&this.CE)&&!Fx)(A=this.C$)?A[1].call(A[0],this):null;if(((this.
Down&&!this.CE)&&Fx)||((!this.Down&&this.CE)&&Fx))(A=this.Da)?A[1].call(A[0],this
):null;if(!!Bg&&!this.Down)(A=this.Cg)?A[1].call(A[0],this):null;if(!!this.Dd){if(((((
this.Dd&0x10)===0x10)&&!!Bg)&&Bg.Down)&&(Bg.Bt>=this.I_))this.DV().Et(null,this,
...
Ad,J,BH,D4,DF){var A;if(!!D4&&(D4!==this))return null;if((BH<this.IB)||(BH>this.
Hx))return null;if((this.Hv>=0)&&(J!==this.Hv))return null;if((!this.In&&this.HS
)&&(J!==this.GM))return null;if(!!(DF&this.Dd))return null;if(this.Iu()){var L=B.
...
I=I+1)if(this.Gj(Au.Get(I)))return B._NewObject(C.EW,0).Initialize(this,B.sn(Au.
Get(I),Au.Get(0)));}return null;},I4:function(value){if(value<1)value=1;this.Eu=
value;},HF:function(value){if(value<1)value=1;this.Hx=value;},BG:function(value){
...
_Mark.call(this,D);if((A=this.Hz)&&((A=A[0])._cycle!=D))A._Mark(A._cycle=D);if((
...
DO:0,Y:null,AG:0,HI:0,Cg:null,B2:null,Em:null,C9:148,AI:0,Ak:0,BL:true,Down:false
,Ff:false,EU:false,A2:function(Aa){var A;if(!!Aa&&Aa.Iz(this.C9)){this.Down=Aa.Down;
this.AI=Aa.AI;this.Ak=Aa.Ak;this.AG=Aa.AG;this.EU=false;if(Aa.Down){this.HI=this.
...
Aa.Down){this.Ff=this.DO>1;this.HI=this.DO-1;this.DO=0;(A=this.Cg)?A[1].call(A[0
],this):null;return!this.EU;}}return false;},BN:function(aArg){var A;var BJ=(C.Ah.
isPrototypeOf(A=this.Af)?A:null);if(!BJ)throw new Error(GG);this.Y=BJ.FB;BJ.FB=this;
...
A._cycle=D);if((A=this.Af)&&(A._cycle!=D))A._Mark(A._cycle=D);},Af:null,_cycle:0
,_observers:null,_className:"Core::CursorHit"};C.Hy={BJ:null,_Init:function(aArg
){this.__proto__=C.Hy;B.gb++;},_Done:function(){this.__proto__=C.Hy;B.gb--;},_ReInit:
...
C.E4;},_className:"Core::LayoutQuadContext"};C.Hg={BJ:null,_Init:function(aArg){
this.__proto__=C.Hg;B.gb++;},_Done:function(){this.__proto__=C.Hg;B.gb--;},_ReInit:
function(){},_Mark:function(D){var A;if((A=this.BJ)&&(A._cycle!=D))A._Mark(A._cycle=
D);if((A=this.Af)&&(A._cycle!=D))A._Mark(A._cycle=D);},Af:null,_cycle:0,_observers:
null,_className:"Core::DialogContext"};C.HK={GR:null,Bl:null,_Init:function(aArg
){this.__proto__=C.HK;B.gb++;},_Done:function(){this.__proto__=C.HK;B.gb--;},_ReInit:
function(){},_Mark:function(D){var A;if((A=this.GR)&&(A._cycle!=D))A._Mark(A._cycle=
...
};C.HJ={_Init:function(aArg){this.__proto__=C.HJ;B.gb++;},_Done:function(){this.
__proto__=C.HJ;B.gb--;},_ReInit:function(){},_Mark:function(D){var A;if((A=this.
...
)tmp.DestroyTimer();this.timer=null;},FJ:function(aBegin,aPeriod){if(aBegin<0)aBegin=
...
)return;this.Period=value;if(this.BL)this.FJ(this.Eb,value);},E6:function(value){
if(value<0)value=0;if(value===this.Eb)return;this.Eb=value;if(this.BL)this.FJ(value
,this.Period);},BG:function(value){if(value===this.BL)return;this.BL=value;if(value
)this.FJ(this.Eb,this.Period);else this.FJ(0,0);this.AG=this.E0();},E0:function(
...
D);if((A=this.Af)&&(A._cycle!=D))A._Mark(A._cycle=D);},Af:null,_cycle:0,_observers:
null,_className:"Core::Timer"};C.Km={Kn:0x1,JL:0x2,JS:0x4,Kk:0x8,BL:0x10,Kf:0x20
,JT:0x40,J0:0x80,JR:0x100,JX:0x200,JP:0x400,J6:0x800,HM:0x1000,Kl:0x2000,J4:0x4000
,J5:0x8000,JO:0x10000,J3:0x20000,Kc:0x40000};C.Cf={J7:0x1,J8:0x2,JI:0x4,JJ:0x8,JK:
0x10,JH:0x20};C.EZ={J1:0,Kj:1,JN:2,JY:3,J_:4};C.KeyCode={NoKey:0,Ok:1,Exit:2,Menu:
...
343,ShiftHome:344,ShiftEnd:345,ShiftTab:346};C.J9={Kr:0x1,Ko:0x2,Kp:0x4,Kq:0x8,JZ:
0x10};
C._Init=function(){C.Er.__proto__=C.Bu;C.AN.__proto__=C.Bu;C.Ah.__proto__=C.AN;C.
Root.__proto__=C.Ah;C.KeyEvent.__proto__=C.Event;C.FQ.__proto__=C.Event;C.EV.__proto__=
