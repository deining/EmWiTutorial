...
.Source code
****
TIP: If you didn't author or didn't keep the _Hello world_ project explained in the previous xref::HelloWorld.adoc[chapter], you may download the link:{attachmentsdir}/HelloWorldTutorial.zip[sources] of this project and use this a starting base to follow the instructions given below.
****
'''
...
* Press kbd:[c] twice: the first key press open the _**C**hora_ folder, the second key press will then open the invoke folder _**C**omponent templates_, that's what we need. Alternatively, you may mouse click on the header titled _Component templates_ inside the main area of the templates window. This will also open the folder and show all available GUI templates.
...
.Source code
****
TIP: If you encountered difficulties and didn't succeed when following the instructions given above, you may download the link:{attachmentsdir}/FirstComponentTutorial.zip[project sources] of the finalized example on how to build your first component.
****
'''
