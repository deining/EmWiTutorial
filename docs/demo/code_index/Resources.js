...
);if(index.tf)throw new Error("The unit file 'Resources.js' included twice!");index.
tf=(function(){var B=index;var C={};
var Ai=[0,0];var AF="The property \'FrameSize\' is READ ONLY.";
C.X={bitmap:null,FrameDelay:0,NoOfFrames:1,FrameSize:B.pm,B1:false,DW:false,Cq:function(
){if(!this.bitmap)return;var handle=this.bitmap;B.rK(handle);this.bitmap=null;this.
FrameSize=Ai;this.FrameDelay=0;this.NoOfFrames=1;this.B1=false;},BO:function(aArg
...
this.FrameSize=frameSize;this.FrameDelay=frameDelay;this.DW=true;this.B1=(!!this.
bitmap&&(this.FrameDelay>0))&&(this.NoOfFrames>1);},Gw:function(value){throw new
Error(AF);},Update:function(){},_Init:function(aArg){B.Core.Dd._Init.call(this,aArg
);this.__proto__=C.X;this.BO(aArg);},_Done:function(){this.__proto__=C.X;this.Cq(
);B.Core.Dd._Done.call(this);},_className:"Resources::Bitmap"};C.AY={font:null,Leading:
0,Descent:0,Ascent:0,Cq:function(){if(!this.font)return;var handle=this.font;B.rL(
handle);this.font=null;this.Ascent=0;this.Descent=0;this.Leading=0;},BO:function(
...
Leading=leading;},Hn:function(aFlowString){if(!this.font)return 0;var handle=this.
font;var advance=0;advance=B.rR(handle,aFlowString);return advance;},I9:function(
...
Ascent;},_Init:function(aArg){B.Core.Dd._Init.call(this,aArg);this.__proto__=C.AY;
this.BO(aArg);},_Done:function(){this.__proto__=C.AY;this.Cq();B.Core.Dd._Done.call(
this);},_className:"Resources::Font"};C.Gb={_class:function(){return C.AY;},0:{Data:
function(){return B.tp;},Cache:[],_this:null}};C.Ga={_class:function(){return C.
AY;},0:{Data:function(){return B.to;},Cache:[],_this:null}};C.F$={_class:function(
){return C.AY;},0:{Data:function(){return B.tn;},Cache:[],_this:null}};
C._Init=function(){C.X.__proto__=B.Core.Dd;C.AY.__proto__=B.Core.Dd;};C.AO=function(
D){var A;if((A=C.Gb[0]._this)&&(A._cycle!=D))A._Done(C.Gb[0]._this=null);if((A=C.
Ga[0]._this)&&(A._cycle!=D))A._Done(C.Ga[0]._this=null);if((A=C.F$[0]._this)&&(A.
_cycle!=D))A._Done(C.F$[0]._this=null);};return C;})();
