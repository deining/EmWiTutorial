...
var BH=[0,0,0,0];var BW="No graphics engine bitmap attached to this canvas";var BX=
"The canvas is already initialized with a graphics engine bitmap";var CX="WarpBitmap() operation has been omitted due to the resulting area "+
...
C.Canvas={Ct:B.pn,HC:null,Dt:0,EB:false,Cq:function(){if(this.EB)this.DetachBitmap(
);},BO:function(aArg){this.DW=true;},Gw:function(value){if((value[0]<=0)||(value[
1]<=0))value=Ai;if(B.sa(value,this.FrameSize))return;if(this.EB)throw new Error(
AF);this.FrameSize=value;this.B1=(((this.FrameSize[0]>0)&&(this.FrameSize[1]>0))&&(
...
Ai;this.FrameDelay=0;this.NoOfFrames=1;}this.Ct=[].concat(Ai,this.FrameSize);}if(
!(((A=this.Ct)[0]>=A[2])||(A[1]>=A[3]))){if((this.FrameSize[0]>0)&&(this.FrameSize[
1]>0))(A=this.HC)?A[1].call(A[0],this):null;this.Ct=BH;}},DetachBitmap:function(
){if(!this.EB)throw new Error(BW);this.bitmap=null;this.EB=false;this.FrameSize=
Ai;this.FrameDelay=0;this.NoOfFrames=1;this.B1=false;return this;},AttachBitmap:
function(aBitmap){if(!!this.bitmap)throw new Error(BX);if(!aBitmap)return this;this.
...
this.B1=(this.FrameDelay>0)&&(this.NoOfFrames>1);return this;},Hk:function(aClip
,GJ,aString,aOffset,aCount,aDstRect,aSrcPos,aMinWidth,GM,aColorTL,aColorTR,aColorBR
...
var orient=0;if(GM===1)orient=90;else if(GM===2)orient=180;else if(GM===3)orient=
270;var dstFrameNo=this.Dt;var dstBitmap=this.bitmap;var srcFont=GJ.font;{B.mf(dstBitmap
...
aBitmap.bitmap;var dstFrameNo=this.Dt;var srcRect=[].concat(Ai,aBitmap.FrameSize
...
)){B.ta("%s",CX);return;}var dstBitmap=this.bitmap;var srcBitmap=aBitmap.bitmap;
var dstFrameNr=this.Dt;{B.tc(dstBitmap,srcBitmap,dstFrameNr,aFrameNr,aClip,aDstX1
,aDstY1,aDstW1,aDstX2,aDstY2,aDstW2,aDstX3,aDstY3,aDstW3,aDstX4,aDstY4,aDstW4,aSrcRect
...
var dstFrameNo=this.Dt;{B.tc(dstBitmap,srcBitmap,dstFrameNo,aFrameNr,aClip,left,
top,1,right,top,1,right,bottom,1,left,bottom,1,aSrcRect,aColorTL,aColorTR,aColorBR
,aColorBL,aBlend,aFilter);}},Hg:function(aClip,aBitmap,aFrameNr,aDstRect,aSrcPos
...
this.Dt;{B.fo(dstBitmap,srcBitmap,dstFrameNr,aFrameNr,aClip,aDstRect,aSrcPos,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend);}},Hj:function(aClip,aDstRect,aEdgeWidth,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap
)return;var dstBitmap=this.bitmap;var dstFrameNo=this.Dt;{B.rF(dstBitmap,dstFrameNo
,aClip,aDstRect,aEdgeWidth,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},F0:function(
aClip,aDstRect,aColorTL,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.
Update();if(!this.bitmap)return;var dstBitmap=this.bitmap;var dstFrameNo=this.Dt;{
...
BO(aArg);},_Done:function(){this.__proto__=C.Canvas;this.Cq();B.tf.X._Done.call(
this);},_Mark:function(D){var A;B.tf.X._Mark.call(this,D);if((A=this.HC)&&((A=A[
0])._cycle!=D))A._Mark(A._cycle=D);},_className:"Graphics::Canvas"};C.Hl={Left:0x1
